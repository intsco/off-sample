...
def train_generator(batch_size, train_path, image_folder, mask_folder, aug_dict, image_color_mode="grayscale",
                    ...
                    flag_multi_class=False, num_class=2, save_to_dir=None, target_size=(256, 256), seed=13):
    """
...
def test_generator(test_path, num_image=30, as_gray=True):
    test_path_gen = Path(test_path).iterdir()
    for i in range(num_image):
        img_path = next(test_path_gen)
...
def save_result(save_path, images):
